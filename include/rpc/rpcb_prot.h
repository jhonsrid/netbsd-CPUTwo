...
bool_t xdr_rpcb_entry(XDR *, rpcb_entry *);
bool_t xdr_rpcb_entry_list(XDR *, rpcb_entry_list *);
bool_t xdr_rpcb_entry_list_ptr(XDR *, rpcb_entry_list_ptr *);
bool_t xdr_rpcbs_addrlist(XDR *, rpcbs_addrlist *);
bool_t xdr_rpcbs_rmtcalllist(XDR *, rpcbs_rmtcalllist *);
bool_t xdr_rpcbs_proc(XDR *, rpcbs_proc);
bool_t xdr_rpcbs_addrlist_ptr(XDR *, rpcbs_addrlist_ptr *);
bool_t xdr_rpcbs_rmtcalllist_ptr(XDR *, rpcbs_rmtcalllist_ptr *);
bool_t xdr_rpcb_stat(XDR *, rpcb_stat *);
bool_t xdr_rpcb_stat_byvers(XDR *, rpcb_stat_byvers);
__END_DECLS
...
__BEGIN_DECLS
bool_t *rpcbproc_set_3(rpcb *, CLIENT *);
bool_t *rpcbproc_set_3_svc(rpcb *, struct svc_req *);
bool_t *rpcbproc_unset_3(rpcb *, CLIENT *);
bool_t *rpcbproc_unset_3_svc(rpcb *, struct svc_req *);
char **rpcbproc_getaddr_3(rpcb *, CLIENT *);
char **rpcbproc_getaddr_3_svc(rpcb *, struct svc_req *);
rpcblist_ptr *rpcbproc_dump_3(void *, CLIENT *);
rpcblist_ptr *rpcbproc_dump_3_svc(void *, struct svc_req *);
rpcb_rmtcallres *rpcbproc_callit_3(rpcb_rmtcallargs *, CLIENT *);
rpcb_rmtcallres *rpcbproc_callit_3_svc(rpcb_rmtcallargs *, struct svc_req *);
u_int *rpcbproc_gettime_3(void *, CLIENT *);
u_int *rpcbproc_gettime_3_svc(void *, struct svc_req *);
struct netbuf *rpcbproc_uaddr2taddr_3(char **, CLIENT *);
struct netbuf *rpcbproc_uaddr2taddr_3_svc(char **, struct svc_req *);
char **rpcbproc_taddr2uaddr_3(struct netbuf *, CLIENT *);
char **rpcbproc_taddr2uaddr_3_svc(struct netbuf *, struct svc_req *);
bool_t *rpcbproc_set_4(rpcb *, CLIENT *);
bool_t *rpcbproc_set_4_svc(rpcb *, struct svc_req *);
bool_t *rpcbproc_unset_4(rpcb *, CLIENT *);
bool_t *rpcbproc_unset_4_svc(rpcb *, struct svc_req *);
char **rpcbproc_getaddr_4(rpcb *, CLIENT *);
char **rpcbproc_getaddr_4_svc(rpcb *, struct svc_req *);
rpcblist_ptr *rpcbproc_dump_4(void *, CLIENT *);
rpcblist_ptr *rpcbproc_dump_4_svc(void *, struct svc_req *);
rpcb_rmtcallres *rpcbproc_bcast_4(rpcb_rmtcallargs *, CLIENT *);
rpcb_rmtcallres *rpcbproc_bcast_4_svc(rpcb_rmtcallargs *, struct svc_req *);
u_int *rpcbproc_gettime_4(void *, CLIENT *);
u_int *rpcbproc_gettime_4_svc(void *, struct svc_req *);
struct netbuf *rpcbproc_uaddr2taddr_4(char **, CLIENT *);
struct netbuf *rpcbproc_uaddr2taddr_4_svc(char **, struct svc_req *);
char **rpcbproc_taddr2uaddr_4(struct netbuf *, CLIENT *);
char **rpcbproc_taddr2uaddr_4_svc(struct netbuf *, struct svc_req *);
char **rpcbproc_getversaddr_4(rpcb *, CLIENT *);
char **rpcbproc_getversaddr_4_svc(rpcb *, struct svc_req *);
rpcb_rmtcallres *rpcbproc_indirect_4(rpcb_rmtcallargs *, CLIENT *);
rpcb_rmtcallres *rpcbproc_indirect_4_svc(rpcb_rmtcallargs *, struct svc_req *);
rpcb_entry_list_ptr *rpcbproc_getaddrlist_4(rpcb *, CLIENT *);
rpcb_entry_list_ptr *rpcbproc_getaddrlist_4_svc(rpcb *, struct svc_req *);
rpcb_stat *rpcbproc_getstat_4(void *, CLIENT *);
rpcb_stat *rpcbproc_getstat_4_svc(void *, struct svc_req *);
__END_DECLS
